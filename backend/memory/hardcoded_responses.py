...
def check_hardcoded_responses(message: str) -> Optional[str]:
    ...
    rules = [
        ...
        (re.compile(r"who (are|r) you"), "I'm Kuro, an AI assistant created by wanna and the Kuro team."),
        (re.compile(r"what is your name"), "I'm Kuro, your multi-personality AI assistant."),
        (re.compile(r"who (is|are) your creator|who made you|who built you"), "I was created by wanna and the Kuro team."),
        (re.compile(r"who owns you"), "I was created and am maintained by wanna and the Kuro team."),
        ...
        (re.compile(r"who is wanna|tell me about wanna"), "Wanna is my creator and the lead developer behind Kuro."),
        (re.compile(r"who developed you|who programmed you|who designed you"), "I was developed by wanna and the Kuro team."),
        ...
        (['your', 'creator'], "I was created by wanna and the Kuro team."),
        (['your', 'owner'], "I was created and am maintained by wanna and the Kuro team."),
        (['your', 'skills'], "I can chat, answer questions, and help with a variety of tasks using multiple AI models and personalities."),
        (['who', 'wanna'], "Wanna is my creator and the lead developer behind Kuro."),
